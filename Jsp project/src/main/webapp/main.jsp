        ...
        <div
            ...
            <div class="hero-content">
                ...
                <form
                    ...
                    action="<%= request.getContextPath() %>/place/search.do"
                ...
                <div class="popular-search">
                    ...
                    <a href="<%= request.getContextPath() %>/place/search.do?keyword=도쿄&lang=<%= lang %>">
                        #<%= messages.getProperty(
                            "main.popular.tokyo",
                            lang.equals("ja") ? "東京" :
                    ...
                    <a href="<%= request.getContextPath() %>/place/search.do?keyword=오사카&lang=<%= lang %>">
                        #<%= messages.getProperty(
                            "main.popular.osaka",
                            lang.equals("ja") ? "大阪" :
                    ...
                    <a href="<%= request.getContextPath() %>/place/search.do?keyword=후쿠오카&lang=<%= lang %>">
                        #<%= messages.getProperty(
                    ...
                    <a href="<%= request.getContextPath() %>/place/search.do?keyword=맛집&lang=<%= lang %>">
                        #<%= messages.getProperty(
                            "main.popular.food",
                            lang.equals("ja") ? "グルメ" :
                            lang.equals("en") ? "Food" :
                    ...
                    <a href="<%= request.getContextPath() %>/place/search.do?keyword=카페&lang=<%= lang %>">
                        #<%= messages.getProperty(
                            "main.popular.cafe",
                            lang.equals("ja") ? "カフェ" :
                            lang.equals("en") ? "Cafe" :
                    ...
                    <a href="<%= request.getContextPath() %>/place/search.do?keyword=온천&lang=<%= lang %>">
                        #<%= messages.getProperty(
                            "main.popular.onsen",
                            lang.equals("ja") ? "温泉" :
    ...
    <section
        ...
        <div class="section-title">
            ...
            <a
                ...
                href="<%= request.getContextPath() %>/place/category.do?lang=<%= lang %>">
        ...
        <div class="category-grid">
            ...
            <a
                ...
                href="<%= request.getContextPath() %>/place/search.do?category=RESTAURANT&lang=<%= lang %>"
            ...
            <a
                ...
                href="<%= request.getContextPath() %>/place/search.do?category=SHOP&lang=<%= lang %>"
            ...
            <a
                ...
                href="<%= request.getContextPath() %>/place/search.do?category=CAFE&lang=<%= lang %>"
